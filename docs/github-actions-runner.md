...
```text
ansible/playbooks/stage-2b/core-tenant/25-github-runner-setup.yml
```

The playbook is intentionally inventory-driven. It only orchestrates collection
roles:
...
./scripts/ansible-nav run \
  playbooks/stage-2b/core-tenant/25-github-runner-setup.yml \
