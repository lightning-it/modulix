...
|---|---|---|
| Ubuntu GitHub Actions self-hosted runner | Supported | Configured by `runbooks/stage-2b/core-tenant/25-github-runner-setup.yml` using `lit.ubuntu.github_runner` |
| Ubuntu Incus host | Supported | Configured by `runbooks/stage-2b/core-tenant/27-incus-host-setup.yml` using `lit.ubuntu.incus` |
